...
class Alice {
  ...
  /// Enable headless QA export. After each HTTP response, Alice writes all
  /// completed calls to alice_qa_export.json in app-specific external storage.
  /// Retrieve via: adb pull /sdcard/Android/data/<pkg>/files/alice_qa_export.json
  void enableQAExport() {
    _aliceCore.enableQAExport();
  }
